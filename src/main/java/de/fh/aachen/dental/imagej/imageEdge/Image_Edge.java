...
public class Image_Edge implements PlugIn {
	...
	private void showAbout() {
		IJ.showMessage("About de.fh.aachen.dental.imagej.imageEdge.ImageEdge",
				...
				"The JAR file contains a class de.fh.aachen.dental.imagej.imageEdge.ImageEdge with static methods that can\n"+
				"be used to implement these filters in other plugins.\n \n"+
				"Authors : Thomas Boudier, Joris Meys (modification de.fh.aachen.dental.imagej.imageEdge.ImageEdge for static access)\n"+
	...
	private void EdgeDetection(ImagePlus img) {
		// Set parameters
